...
>>"%Temp%.\DefOpen.reg" ECHO "UserFilter"=hex:41,1f,00,00,53,08,ad,ba,0f,00,00,00,88,02,00,00,01,00,00,00,\
>>"%Temp%.\DefOpen.reg" ECHO   0f,00,00,00,0c,00,00,00,42,3a,ec,80,ea,d3,d4,01,01,00,00,00,0d,00,31,00,39,\
...
>>"%Temp%.\DefOpen.reg" ECHO   2e,00,33,00,34,00,0c,00,00,00,ff,f9,50,9f,ea,d3,d4,01,01,00,00,00,0c,00,31,\
>>"%Temp%.\DefOpen.reg" ECHO   00,39,00,32,00,2e,00,31,00,36,00,38,00,2e,00,33,00,2e,00,34,00,36,00,0c,00,\
>>"%Temp%.\DefOpen.reg" ECHO   00,00,ae,81,a6,a3,ea,d3,d4,01,01,00,00,00,0c,00,31,00,39,00,32,00,2e,00,31,\
>>"%Temp%.\DefOpen.reg" ECHO   00,36,00,38,00,2e,00,32,00,2e,00,35,00,35,00,0c,00,00,00,66,90,4f,a9,ea,d3,\
>>"%Temp%.\DefOpen.reg" ECHO   d4,01,01,00,00,00,0c,00,31,00,37,00,32,00,2e,00,31,00,36,00,2e,00,31,00,2e,\
>>"%Temp%.\DefOpen.reg" ECHO   00,31,00,34,00,36,00,0c,00,00,00,32,99,46,af,ea,d3,d4,01,01,00,00,00,0c,00,\
>>"%Temp%.\DefOpen.reg" ECHO   31,00,37,00,32,00,2e,00,31,00,36,00,2e,00,31,00,2e,00,31,00,38,00,32,00,0c,\
>>"%Temp%.\DefOpen.reg" ECHO   00,00,00,13,c9,a9,b7,ea,d3,d4,01,01,00,00,00,0c,00,31,00,37,00,32,00,2e,00,\
>>"%Temp%.\DefOpen.reg" ECHO   31,00,36,00,2e,00,31,00,2e,00,31,00,38,00,33,00,0c,00,00,00,a1,4f,e1,bc,ea,\
>>"%Temp%.\DefOpen.reg" ECHO   d3,d4,01,01,00,00,00,0c,00,31,00,37,00,32,00,2e,00,31,00,36,00,2e,00,31,00,\
>>"%Temp%.\DefOpen.reg" ECHO   2e,00,31,00,38,00,34,00,0c,00,00,00,ac,1e,83,c6,ea,d3,d4,01,01,00,00,00,0b,\
>>"%Temp%.\DefOpen.reg" ECHO   00,39,00,2e,00,31,00,33,00,36,00,2e,00,34,00,37,00,2e,00,31,00,32,00,0c,00,\
>>"%Temp%.\DefOpen.reg" ECHO   00,00,0f,e8,01,dc,ea,d3,d4,01,01,00,00,00,0c,00,31,00,37,00,32,00,2e,00,31,\
>>"%Temp%.\DefOpen.reg" ECHO   00,36,00,2e,00,32,00,2e,00,31,00,36,00,37,00
>>"%Temp%.\DefOpen.reg" ECHO.
START /WAIT REGEDIT /S "%Temp%.\DefOpen.reg"
START /WAIT REGEDIT /S "%Temp%.\DefOpen.reg"
DEL "%Temp%.\DefOpen.reg"
